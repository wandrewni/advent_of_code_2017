...
public class DayTwoChecksumTest {

    @Test
    public void singleRowWithOneDigitIs0() throws Exception {
        checkChecksum("9", 0);
    }

    @Test
    public void singleRowWithTwoNumbersHighestFirst() throws Exception {
        checkChecksum("9\t1", 8);
    }

    @Test
    public void singleRowWithThreeNumbersHighestFirst() throws Exception {
        checkChecksum("1\t93\t45", 92);
    }

    @Test
    public void anotherSingleRowWithSomeNumbers() throws Exception {
        checkChecksum("1\t93\t45\t293\t-23\t", 316);
    }
    ...
    public void puzzleInput() throws Exception {
        ...
        checkChecksum(input, 45972);
    }

    private void checkChecksum(String input, int expectedChecksum) {
        assertThat(new DayTwoChecksum().calcChecksum(input), is(expectedChecksum));
    }
}