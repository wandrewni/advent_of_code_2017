...
public class Day10KnotHashPartTwoTest extends Day10KnotHashTest {
    ...
    public void verifyIntegerToBinaryConversion() throws Exception {
        ...
        knotHash.twist(new Day10KnotHash.AsciiLengthsGenerator("1,2,3"));
        verifyHash(expectedHash);

        createHash(IntStream.range(0, 60).boxed().toArray(Integer[]::new));
        //   1  ,  2  ,  3
        knotHash.twist(new Day10KnotHash.IntegerLengthsGenerator(49, 44, 50, 44, 51));
        verifyHash(expectedHash);
    }
    ...
    public void hashWithExtraSequence() throws Exception {
        ...
        knotHash.twist(new Day10KnotHash.IntegerLengthsGenerator(49, 44, 50, 44, 51, 17, 31, 73, 47, 23));
        verifyHash(expectedHash);

        createHash(IntStream.range(0, 75).boxed().toArray(Integer[]::new));

        knotHash.twist(new Day10KnotHash.AsciiLengthsGeneratorWithSuffix("1,2,3"));
        verifyHash(expectedHash);
    }
    ...
    public void withBitWiseOrDensifierProducesCorrectHash() throws Exception {
        ...
        knotHash.setDensifier(new Day10KnotHash.BitWiseOrDensifier());
        knotHash.twist(new Day10KnotHash.IntegerLengthsGenerator(2, 5, 10, 1, 2));
    ...
    private void verifyStandardHash(String lengthString, String expectedHash) {
        ...
        knotHash.setRepititions(64);
        knotHash.setDensifier(new Day10KnotHash.BitWiseOrDensifier());
        knotHash.twist(new Day10KnotHash.AsciiLengthsGeneratorWithSuffix(lengthString));
    ...
    void twist(Integer... integers) {
        ...
        knotHash.twist(new Day10KnotHash.AsciiLengthsGenerator(asString));
    }
}
